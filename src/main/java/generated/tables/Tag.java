...
public class Tag extends TableImpl<TagRecord> {
	...
	private static final long serialVersionUID = 1836804893;
	...
	/**
	 * The column <code>public.tag.tid</code>.
	 */
	public final TableField<TagRecord, Integer> TID = createField("tid", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "");
